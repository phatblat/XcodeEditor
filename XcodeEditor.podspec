#
# Be sure to run `pod spec lint XcodeEditor.podspec' to ensure this is a
# valid spec.
#
...
Pod::Spec.new do |s|
  ...
  # s.authors      = { "Ben Chatelain" => "ben.d.chatelain@kp.org", "other author" => "and email address" }
  #
  # If absolutely no email addresses are available, then you can use this form instead.
  #
  # s.author       = 'Ben Chatelain', 'other author'
  ...
  #
  s.source_files = 'Source', 'Source/Main/**/*.{h,m}'
